import { Button, Card, Grid, Group, InputWrapper, Select, Text, TextInput } from "@mantine/core";
import { useState } from "react";

export default function FreezeSubTaskForm(props: {add: (name: string) => void}) {
    const [name, setName] = useState("");
    return (<Card shadow="sm" p="sm" style={{ marginTop: 20, paddingBottom: 20 }}>
        <Group position="apart">
            <Text weight={500}>冻结测试</Text>
